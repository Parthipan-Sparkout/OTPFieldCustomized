...
public class OTPTextField: UITextField {
    ...
    /// The delegate of the CustomOTPTextFieldDelegate protocol
    public weak var otpDelegate: CustomOTPTextFieldDelegate?

    private var implementation = CustomOTPTextFieldImplementation()
    ...
    // MARK: - METHODS
    //
    /// This func is used to configure the `CustomOTPTextField`, Usually you need to call this method into `viewDidLoad()`
    ...
    /// Use this func if you need to clear the `OTP` text and reset the `CustomOTPTextField` to the default state
...
// MARK: - CustomOTPTextFieldImplementationProtocol Delegate
//
extension OTPTextField: CustomOTPTextFieldImplementationProtocol {
...
public protocol CustomOTPTextFieldDelegate: AnyObject {
